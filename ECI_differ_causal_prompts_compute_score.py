...
"""
python ECI_differ_causal_prompts_compute_score.py \
--output_dir <output_dir output by ECI_differ_causal_prompts.py>
"""
...
for itemid, item in enumerate(items):
    gpt_pred_bi_causal_label = max(item["gpt_pred_bi_causal_label"])
